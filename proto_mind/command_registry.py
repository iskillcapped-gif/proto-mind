...
_BASE_REGISTRY = [
    ...
    *_read_only_specs(
        "skills",
        {
            ...
            "/skills lifecycle-status": "Summarize restart-safe procedural skill lifecycle facts, restore contracts, or process-local restore receipts.",
            "/skills lifecycle-history": "List durable procedural skill states without inventing transition history.",
            "/skills lifecycle-inspect": "Inspect durable lifecycle evidence, restore authorization/apply preview, or a process-local restore receipt.",
            "/skills lifecycle-doctor": "Audit durable lifecycle classification, restore authorization/apply gates, receipts, and no-invention boundaries.",

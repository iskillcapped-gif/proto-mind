...
_BASE_REGISTRY = [
    ...
    *_read_only_specs(
        "skills",
        {
            ...
            "/skills lifecycle-status": "Summarize restart-safe procedural skill lifecycle facts or inspect archive/restore authorization contracts.",
            "/skills lifecycle-history": "List durable procedural skill states without inventing transition history.",
            "/skills lifecycle-inspect": "Inspect one procedural skill's durable lifecycle evidence or read-only restore authorization readiness/plan.",
            "/skills lifecycle-doctor": "Audit durable procedural skill lifecycle classification, restore authorization design, and no-invention boundaries.",

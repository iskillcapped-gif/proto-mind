...
_BASE_REGISTRY = [
    ...
    *_read_only_specs(
        "experience",
        {
            ...
            "/experience learning skill-outcome-capture-preview": "Preview one exact provenance-bound manual skill outcome capture.",
            "/experience learning skill-outcome-captures": "List or inspect bounded process-memory manual skill outcome receipts.",
            "/experience learning skill-outcome-capture-doctor": "Diagnose manual skill outcome receipts, event lineage, and no-execution boundaries.",

...
_BASE_REGISTRY = [
    ...
    *_read_only_specs(
        "skills",
        {
            ...
            "/skills lifecycle-status": "Summarize restart-safe procedural skill lifecycle facts.",
            "/skills lifecycle-history": "List durable procedural skill states without inventing transition history.",
            "/skills lifecycle-inspect": "Inspect one procedural skill's durable lifecycle evidence.",
            "/skills lifecycle-doctor": "Audit durable procedural skill lifecycle classification and no-invention boundaries.",

...
_BASE_REGISTRY = [
    ...
    *_read_only_specs(
        "experience",
        {
            ...
            "/experience learning skill-outcome-lifecycle-apply-preview": "Preview one exact keep/archive lifecycle transition after current readiness revalidation.",
            "/experience learning skill-outcome-lifecycle-applies": "List or inspect the bounded process-memory lifecycle apply receipt.",
            "/experience learning skill-outcome-lifecycle-apply-doctor": "Diagnose lifecycle apply receipts, current skill state, rollback, and non-execution boundaries.",
    ...
    _spec(
        ...
        "experience",
        "Apply one exact confirmed keep no-op or atomic skill archive transition.",
        read_only=False,
        mutates="skills",
        risk="medium",
        notes="Run-once supervised lifecycle gate; revise and procedure execution remain unavailable.",
    ),
    _spec(

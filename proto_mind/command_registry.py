...
_BASE_REGISTRY = [
    ...
    *_read_only_specs(
        "experience",
        {
            ...
            "/experience learning": "Inspect evidence-backed candidates, decisions, proposals, later outcomes, supervised lifecycle transitions, and durable lifecycle audit state.",

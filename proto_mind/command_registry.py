...
_BASE_REGISTRY = [
    ...
    *_read_only_specs(
        "experience",
        {
            ...
            "/experience learning skill-outcome-review": "Review exact manual procedural-skill outcome evidence, including restore-bound temporal re-evaluation, without scoring or mutation.",
            "/experience learning skill-outcome-doctor": "Diagnose procedural-skill outcome evidence, post-restore binding, legacy-path guards, and no-execution boundaries.",
            "/experience learning skill-outcome-capture-preview": "Preview one exact provenance-bound manual skill outcome capture or a read-only restore-bound future capture blueprint.",
            "/experience learning skill-outcome-captures": "List or inspect bounded process-memory manual skill outcome receipts.",
            "/experience learning skill-outcome-capture-doctor": "Diagnose manual skill outcome receipts, restore-bound future capture readiness, event lineage, and no-execution boundaries.",
            "/experience learning skill-outcome-decision-preview": "Preview one exact operator keep/revise/archive decision over confirmed skill outcome evidence.",
            "/experience learning skill-outcome-decisions": "List or inspect bounded process-memory procedural skill outcome decisions.",
            "/experience learning skill-outcome-decision-doctor": "Diagnose skill outcome decisions, evidence binding, and no-apply boundaries.",
            "/experience learning skill-outcome-lifecycle-readiness": "Revalidate a terminal skill outcome decision against current evidence, provenance, and Skill Library bytes.",
            "/experience learning skill-outcome-lifecycle-plan": "Show future keep/archive/revision safeguards without generating an apply token.",
            "/experience learning skill-outcome-lifecycle-doctor": "Diagnose lifecycle readiness while enforcing the supervised apply and absent-execution boundaries.",
            "/experience learning skill-outcome-lifecycle-apply-preview": "Preview one exact keep no-op or --durable archive transition after current readiness revalidation.",
            "/experience learning skill-outcome-lifecycle-applies": "List or inspect bounded process-memory legacy or --durable lifecycle apply receipts.",
            "/experience learning skill-outcome-lifecycle-apply-doctor": "Diagnose legacy or --durable lifecycle apply receipts, current skill state, rollback, and non-execution boundaries.",
    ...
    _spec(
        ...
        "experience",
        "Capture one exact operator-reported manual skill outcome in bounded process memory.",
        read_only=False,
        mutates="session",
        risk="medium",
        notes="Exact-token process-memory evidence only; Proto-Mind does not invoke or update the skill.",
    ),
    _spec(
        "/experience learning decide skill-outcome",
        "experience",
        "Record one exact terminal keep/revise/archive skill outcome decision in process memory.",
        read_only=False,
        mutates="session",
        risk="medium",
        notes="Operator decision receipt only; grants no Skill Library apply readiness or execution authority.",
    ),
    _spec(
        "/experience learning apply skill-outcome-lifecycle",
        "experience",
        "Apply one exact confirmed keep no-op or --durable atomic skill archive transition.",
        read_only=False,
        mutates="skills",
        risk="medium",
        notes="Run-once supervised gate; archive requires --durable metadata, while revise and procedure execution remain unavailable.",
    ),
    _spec(
    ...
    *_read_only_specs(
        "skills",
        {
            ...
            "/skills lifecycle-status": "Summarize restart-safe procedural skill lifecycle facts, restore contracts, or receipt evidence contracts.",
            "/skills lifecycle-history": "List durable procedural skill states or restore receipt evidence without inventing transition history.",
            "/skills lifecycle-inspect": "Inspect durable lifecycle evidence, restore authorization/apply state, or restart-safe receipt evidence.",
            "/skills lifecycle-doctor": "Audit lifecycle classification, restore gates, process receipts, durable receipt evidence, and no-invention boundaries.",
    ...
    *[
        ...
        for prefix, description in {
            ...
            "/skills restore": "Restore a legacy/operator skill; lifecycle-managed restore requires the one exact-token durable gate.",
        }.items()
    ],

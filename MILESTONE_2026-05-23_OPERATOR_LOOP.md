...
- Command Registry v1.0 adds `/commands status|list|explain|doctor`; the current Registry contains 366 prefixes in 41 categories. It exposes category, mutation, risk, and Natural Router metadata; doctor validates duplicates, field values, natural target coverage, explicit context mutations, and exclusion of high-risk natural routes. Registry commands describe but never execute commands.

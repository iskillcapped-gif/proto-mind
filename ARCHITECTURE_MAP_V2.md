...
- v3.5c / Procedural Skill Apply Readiness revalidates a live authoring receipt against current source and complete Skill Library state, exposes target/store hashes plus atomic receipt/rollback requirements, and generates no apply token or writer path.

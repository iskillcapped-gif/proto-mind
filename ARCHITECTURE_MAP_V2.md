...
`proto_mind/persona_engine.py` + `proto_mind/persona/brother-0.1.0.json` + `proto_mind/persona_evals.py` + `proto_mind/native_persona.py` + `native/Sources/PersonaInspector.swift` (Persona Engine 0.2 / Native visible preview)

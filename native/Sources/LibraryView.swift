            ...
            if let item = detail.item {
                ScrollView {
                    VStack(alignment: .leading, spacing: 21) {
                        ...
                        Text("Просмотр не меняет записи, счётчики использования или фокус. Метаданные не являются новой проверкой достоверности. Диагностика вручную: \(collection.manualDoctor)")

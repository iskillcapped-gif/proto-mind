...
|---|---:|---:|---:|
| Submission-relevant files | 69 | 114 | +45 |
| Python files | 66 | 87 | +21 |
| Unit-test methods | 664 | 854 | +190 |
| Registry commands | 343 | 360 | +17 |
| Registry categories | 39 | 41 | +2 |

The file delta is not inferred from modification time. Every baseline and current submission-relevant file is hashed, then classified as added, changed, removed, or unchanged. The current manifest reports 45 added, 14 changed, 0 removed, and 55 unchanged files.

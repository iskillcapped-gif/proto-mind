...
Expected verified baseline: Python 3.11, 1152 unit tests, 387 registered command prefixes across 41 categories, Context Injection disabled, no persistent live Experience capture, and a four-command fixed read-only runner allowlist.

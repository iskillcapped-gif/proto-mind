...
- v3.5t / Durable Restore Receipt Audit: consider a read-only cross-process audit/export contract for restore envelopes and legacy process receipts before any re-archive or revision capability.
